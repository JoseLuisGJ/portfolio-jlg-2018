(function(angular) {
    ...
    angular.module('myApp.project4Ctrl', ['ngRoute', 'myApp.mainFactory'])

    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/proyectos/muchosol', {
    ...
    .controller('project4Ctrl', ['$scope', '$rootScope', 'mainFactory', 'eventsFactory', function($scope, $rootScope, mainFactory, eventsFactory) {
        angular.element(document).ready(function() {
            ...
            function init() {
                ...
                mainFactory.setNextProject("Aguas de Valencia", "proyectos/aguas-de-valencia");
                mainFactory.setCurrentProject("Muchosol");
