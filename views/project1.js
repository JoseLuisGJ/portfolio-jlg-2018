(function(angular) {
    ...
    angular.module('myApp.project1Ctrl', ['ngRoute', 'myApp.mainFactory'])

    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/proyectos/aguas-de-valencia', {
    ...
    .controller('project1Ctrl', ['$scope', '$rootScope', 'mainFactory', 'eventsFactory', function($scope, $rootScope, mainFactory, eventsFactory) {
        angular.element(document).ready(function() {
            ...
            function init() {
                ...
                mainFactory.setNextProject("Energy System", "proyectos/energy-system");
                mainFactory.setCurrentProject("Aguas de Valencia");
                ...
                if (useScrollMagic) {
                    ...
                    introTl
                        ...
                        .fromTo($('#second-section img.img-proyecto'), 2, {
                            y: "+=50",
                            opacity: 0
                        }, {
                            y: 0,
                ...
                if (useScrollMagic) {
                    // SCROLL MAGIC -> Videos, autoplay al verse
                    $('.obj-video').each(function() {

                        var objVideoScene = new ScrollMagic.Scene({
