(function(angular) {
    ...
    angular.module('myApp.project2Ctrl', ['ngRoute', 'myApp.mainFactory'])

    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/proyectos/energy-system', {
    ...
    .controller('project2Ctrl', ['$scope', '$rootScope', 'mainFactory', 'eventsFactory', function($scope, $rootScope, mainFactory, eventsFactory) {
        angular.element(document).ready(function() {
            ...
            function init() {
                ...
                mainFactory.setNextProject("Zeendo", "proyectos/zeendo");
                mainFactory.setCurrentProject("Energy System");
