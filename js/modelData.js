(function(angular) {
    ...
    .config(['$locationProvider', '$routeProvider', '$translateProvider', '$windowProvider', function($locationProvider, $routeProvider, $translateProvider, $windowProvider) {
        ...
        $translateProvider.translations('en', {
            ...
            'ABOUT-CONT-1': 'I have 12 years professional experience, based in Valencia I have developed projects for clients such as <b>Energy System, Amstel, Lois Jeans, Grefusa and Grupo Aguas de Valencia</b> among others.',
            ...
            'ABOUT-CONT-3': 'Teaching is part of my career. I lead the <a class="hoverLinea" href="http://www.esat.es/estudios/curso-avanzado-de-diseno-web-y-programacion/?pnt=2900" target="_blank">ID3 post degree</a> in ESAT Valencia. Where I also teach UX//UI and web Frontend development in the New Media Arts 2.0 degree.',
            'ABOUT-CONT-4': 'I provide freelance development projects, user experience, user interface design and digital solutions consulting.',
            'ROLE': 'Role',
            'CLIENTE': 'Client',
            // AGUAS DE VALENCIA
            'P1.TITULO': 'Web, APP & interactives',
            'P1.SUBTITULO': 'Grupo Aguas de Valencia',
            'P1.ROLE1': 'UX / UI Designer',
            ...
            // MUCHOSOL
            'P4.TITULO': 'UX / UI Redesign',
            'P4.SUBTITULO': 'Muchosol',
            'P4.ROLE1': 'UX / UI Design',
            'P4.CLIENTE': 'Avantio',
        ...
        $translateProvider.translations('es', {
            ...
            'ABOUT-CONT-1': 'Profesional del sector desde hace 12 años y asentado en Valencia he realizado proyectos para cliente como <b>Energy System, Amstel, Lois Jeans, Grefusa o Grupo Aguas de Valencia</b> entre otros.',
            ...
            'ABOUT-CONT-3': 'La docencia es parte de mi profesión, dirijo el <a class="hoverLinea" href="http://www.esat.es/estudios/curso-avanzado-de-diseno-web-y-programacion/?pnt=2900" target="_blank">Postgrado ID3</a> en ESAT Valencia. Dónde también imparto clases en la carrera de New Media Arts 2.0 de UX / UI y desarrollo web Frontend.',
            'ABOUT-CONT-4': 'Actualmente trabajo como freelance, realizando proyectos de desarrollo, User Experience, User Interface Design y consultoría para soluciones digitales.',
            'ROLE': 'Role',
            'CLIENTE': 'Cliente',
            // AGUAS DE VALENCIA
